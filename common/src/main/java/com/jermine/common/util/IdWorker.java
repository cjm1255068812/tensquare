...
/**
 * @Title Twitter的 Snowflake　JAVA实现方案
 * @Description
...
public class IdWorker {
    ...
    private final static long startMark = 1288834974657L;
    // 机器标识位数
    ...
    public synchronized Long nextId() {
        ...
        return ((timestamp - startMark) << timestampLeftShift)
    ...
    protected static long getMaxWorkerId(long dataCenterId) {
       ...
       */
        return (macPid.toString().hashCode() & 0xffff) % (IdWorker.maxWorkerId + 1);
    }
